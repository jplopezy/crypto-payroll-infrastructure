...
# IAM Role for Lambda functions (if needed for processing)
...
# Custom Lambda policy for S3 and Secrets Manager access
resource "aws_iam_policy" "lambda_policy" {
  name        = "${local.name_prefix}-lambda-policy"
  description = "Policy for Lambda functions to access S3 and Secrets Manager"
