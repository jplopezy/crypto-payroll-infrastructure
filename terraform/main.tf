# Crypto Payroll API Infrastructure
...
resource "aws_secretsmanager_secret" "external_api_key" {
  ...
  description             = "External API key for crypto payroll service"
...
# Security Group for ECS Tasks (simplified without ALB)
...
# ECS Service (simplified without ALB)
  ...
  container_definitions = jsonencode([
    {
      ...
      image = "${data.aws_caller_identity.current.account_id}.dkr.ecr.${var.aws_region}.amazonaws.com/crypto-payroll-api:latest"
