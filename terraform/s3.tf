...
locals {
  bucket_name = var.s3_bucket_name != "" ? var.s3_bucket_name : "${local.name_prefix}-${random_string.bucket_suffix.result}"
}
...
# S3 Bucket for transaction logs and processed files
